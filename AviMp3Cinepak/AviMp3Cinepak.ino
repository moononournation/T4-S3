...
const char *avi_file = "/root/AviMp3Cinepak448p15fps.avi";
...
Arduino_GFX *g = new Arduino_RM690B0(bus, 13 /* RST */, 1 /* rotation */, 450 /* width */, 600 /* height */, 16 /* col offset 1 */, 0 /* row offset 1 */, 16 /* col offset 2 */, 0 /* row offset 2 */);
Arduino_Canvas *gfx = new Arduino_Canvas(600 /* width */, 450 /* height */, g);
#define CANVAS
/*******************************************************************************
